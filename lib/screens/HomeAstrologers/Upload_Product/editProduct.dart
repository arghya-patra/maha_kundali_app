...
class ProductEditScreen extends StatefulWidget {
  String? id;
  ProductEditScreen({required this.id});
  @override
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          print(["#########", productData]);
          _productTitleController.text = productData['product_title'];
          _descriptionController.text = productData['description'];
          _selectedCategoryId = productData['cat_id'];
          _salePriceController.text = productData['sale_price'];
          _productPriceController.text = productData['product_price'];
          _productSizeController.text = productData['size'] ?? '';
          _productWeightController.text = productData['weight'] ?? '';
          _productStockController.text = productData['stock'] ?? '';
