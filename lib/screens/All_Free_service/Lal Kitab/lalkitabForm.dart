...
class LalKitabFormScreen extends StatefulWidget {
  @override
  _LalKitabFormScreenState createState() => _LalKitabFormScreenState();
}

class _LalKitabFormScreenState extends State<LalKitabFormScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Know your Lal Kitab'),
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => LalKitabScreen(
