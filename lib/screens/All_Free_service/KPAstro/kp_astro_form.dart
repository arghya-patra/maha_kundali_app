...
class KpAstroForm extends StatefulWidget {
  @override
  _KpAstroFormState createState() => _KpAstroFormState();
}

class _KpAstroFormState extends State<KpAstroForm>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Know your KP Astrology'),
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => KPAstrologyScreen(
